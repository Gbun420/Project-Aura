...
export class ManifestGenerator {
     ...
     */
    static async generate(db, candidateId, employerId) {
        ...
        if (!proof)
            throw new Error("UNAUTHORIZED_ACCESS: No Introduction Certificate found.");
        ...
        if (!candidate)
            throw new Error(`UNAUTHORIZED_ACCESS: Candidate ${candidateId} not found.`);
