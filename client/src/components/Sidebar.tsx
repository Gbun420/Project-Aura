...
const NavItem = ({ icon: Icon, label, path, badge, active }: NavItemProps) => (
  ...
  >
    ...
    {badge && (
      <span className="bg-nova-pulse/20 text-nova-pulse px-2 py-0.5 rounded text-[9px] font-mono border border-nova-pulse/30">
        {badge}
      </span>
    )}
  </Link>
      ...
      <div className="p-6 border-b border-white/5">
        <div className="flex items-center gap-3">
          <div className="relative group cursor-pointer">
            <div className="absolute inset-0 bg-nova-accent/20 blur-xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
