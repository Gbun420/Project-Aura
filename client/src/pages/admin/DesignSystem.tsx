import { Lock as DesignLock, Cpu as DesignCpu } from 'lucide-react';

export default function DesignSystem() {
  return (
    <div className="p-10 space-y-12 bg-aura-base min-h-screen text-white font-manrope">
      <section>
        <h2 className="text-sm font-black uppercase tracking-[0.3em] text-aura-accent mb-8">01_Branding_Core</h2>
      ...
      <section className="space-y-8">
        <h2 className="text-sm font-black uppercase tracking-[0.3em] text-aura-accent">02_Glass_Architecture</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-8 rounded-[2rem] bg-white/5 border border-white/10 backdrop-blur-xl relative overflow-hidden group">
            <div className="absolute inset-0 bg-aura-glass-gradient opacity-50" />
      ...
      <section className="space-y-8">
        <h2 className="text-sm font-black uppercase tracking-[0.3em] text-aura-accent">03_Neural_Elements</h2>
        <div className="flex flex-wrap gap-6 items-center">
          {/* Neural Badge */}
          <div className="px-4 py-2 bg-aura-pulse/10 border border-aura-pulse/30 rounded-full flex items-center gap-2 animate-pulse">
            <div className="h-1.5 w-1.5 rounded-full bg-aura-pulse shadow-[0_0_8px_#22D3EE]" />
            <span className="text-[10px] font-black font-mono text-aura-pulse uppercase tracking-widest">Compliance_Verified_2026</span>
          </div>
          ...
          {/* Action Button */}
          <button className="px-8 py-4 rounded-2xl bg-gemini-gradient text-white font-black uppercase tracking-widest text-[10px] shadow-xl shadow-aura-accent/20 hover:scale-105 active:scale-95 transition-all flex items-center gap-3">
            <Cpu size={14} />
            Commit_To_Ledger
          </button>
        </div>
      ...
      <section className="space-y-8">
        <h2 className="text-sm font-black uppercase tracking-[0.3em] text-aura-accent">04_Monospace_Data</h2>
        <div className="p-6 rounded-2xl bg-aura-surface border border-white/10 font-mono text-[11px] leading-relaxed text-slate-400">
          <p className="text-aura-pulse mb-2">// SHA-256 SUCCESS_CERTIFICATE</p>
          <p className="break-all text-white/80">AURA_7F8B2C1D_9E0A_4B3F_8C7D_6E5F4G3H2I1J_K9L0M1N2O3P</p>
