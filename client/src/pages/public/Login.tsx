        ...
        <form className="space-y-4" onSubmit={handleLogin}>
          ...
          {resetSent && (
            <div className="rounded-xl border border-green-500/40 bg-green-500/10 px-4 py-3 text-sm text-green-200">
              Password reset link dispatched. Check your inbox.
            </div>
          )}
          ...
          <div className="flex justify-end">
            <button
              ...
              className="text-[10px] font-black uppercase tracking-widest text-nova-pulse hover:text-white transition-colors"
            >
              Forgot Password?
            </button>
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-[10px] uppercase tracking-widest text-slate-500">
              <span className="bg-nova-base px-2">Sovereign Singularity</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/5 py-4 text-sm font-black uppercase tracking-[0.2em] hover:bg-white/10 transition-all active:scale-95 disabled:opacity-60"
          >
